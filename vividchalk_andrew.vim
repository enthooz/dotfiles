...
highlight DiffAdd    ctermfg=0 guifg=Black
" diff mode: Changed line
highlight DiffChange term=bold ctermbg=225 guibg=LightMagenta
highlight DiffChange ctermfg=0 guifg=Black
" diff mode: Changed text within a changed line
highlight DiffText   term=reverse cterm=bold ctermbg=9 gui=bold guibg=Red 
highlight DiffText   ctermfg=15 guifg=White 
" diff mode: Deleted line
highlight DiffDelete term=bold ctermbg=159 gui=bold guibg=LightCyan
highlight DiffDelete ctermbg=1 guibg=DarkBlue
